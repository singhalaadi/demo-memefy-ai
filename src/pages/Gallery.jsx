                ...
                <div className="flex items-center justify-between">
                  <div className="flex gap-6 text-gray-400">
                    <span className="flex items-center gap-2">
                      🔥 <strong>{selectedMeme.likes.toLocaleString()}</strong> likes
                    </span>
                    <span className="flex items-center gap-2">
                      👀 <strong>{selectedMeme.views.toLocaleString()}</strong> views
                    </span>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    >
                      {favorites.has(selectedMeme.id) ? '💖 Favorited' : '🤍 Favorite'}
                    </button>
                    <button
