  ...
  const features = [
    {
      ...
      description: 'Our AI knows every meme format from the classics to the latest TikTok trends'
    },
    {
      emoji: '🔥',
      title: 'Viral Potential',
      description: 'Generate memes that are guaranteed to get those likes, shares, and reactions'
    },
    {
      emoji: '⚡',
    ...
    },
    {
      emoji: '🎯',
      title: 'Trend Tracker',
      description: 'Stay ahead with real-time meme trends from Reddit, Twitter, and TikTok'
    }
  ]
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <p className="text-gray-400 mb-2">Too lazy to sign up? We feel you 😴</p>
            <Link 
              to="/gallery" 
              ...
              >
                ...
                <div className="p-2 text-center">
                  <p className="text-xs text-gray-400 group-hover:text-gray-300">
                    {['This is fire 🔥', 'So relatable 💯', 'Big mood', 'Facts no printer', 'Send this to everyone'][num - 1]}
                  </p>
                </div>
              </motion.div>
            ))}
